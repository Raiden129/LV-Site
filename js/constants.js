...
export const CONFIG = Object.freeze({
    ...
    MAIN_SITE_URL: 'https://your-main-site.pages.dev',
    WORKER_URL: "https://your-image-server.your-subdomain.workers.dev/",
    BACKUP_URL: "https://your-backup-domain.r2.dev"
});
...
export const FILES = Object.freeze({
    MANGA_JSON: 'series.json',
    NOVELS_JSON: 'novel.json',
    PENDING_DELETES: 'data/ops/pending_deletes.json',
    ARCHIVE_MAP: 'data/ops/archive_map.json'
});
...
export const VIEW = Object.freeze({
    ...
    NOVEL_HOME: 'view-novel-home',
    NOVEL_SERIES: 'view-novel-series',
    NOVEL_READER: 'view-novel-reader',
    
    DASHBOARD: 'view-dashboard',
    MANHWA_SERIES: 'view-comic-series',
    SERIES_DETAIL: 'view-series-detail',
    CHAPTER_DETAIL: 'view-chapter-detail',
    NOVEL_ADMIN_SERIES: 'view-novel-admin-series',
    NOVEL_SERIES_DETAIL: 'view-novel-series-detail',
    NOVEL_CHAPTER_DETAIL: 'view-novel-chapter-detail',
    UPLOAD: 'view-upload'
});
...
export const STORAGE_KEYS = Object.freeze({
    ...
    NOVEL_LIBRARY_CACHE: 'novel_library_cache',
    GH_TOKEN: 'gh_token',
    READER_SETTINGS: 'reader_settings',
    HAS_OPENED_SETTINGS: 'has_opened_settings'
});
...
export const DOM_IDS = Object.freeze({
    ...
    NOVEL_SETTINGS_BTN: 'btn-novel-settings'
});

export const PATHS = Object.freeze({
    NOVEL_CONTENT: 'content/novels'
});
...
export const CSS_CLASSES = Object.freeze({
    ...
    UPLOAD_STATUS_TOAST: 'upload-status-toast',
    HIDDEN: 'hidden'
});

export const ANIMATION = Object.freeze({
    FADE_DURATION_MS: 300,
    FADE_OUT: 'fadeIn 0.3s ease reverse'
});
...
export const GISCUS_CONFIG = Object.freeze({
    MAPPING: 'url',
    STRICT: '1',
    REACTIONS_ENABLED: '1',
    EMIT_METADATA: '0',
...
export const DRAG_DROP_EVENTS = Object.freeze({
    ENTER: 'dragenter',
    OVER: 'dragover',
    LEAVE: 'dragleave',
    DROP: 'drop'
...
export const ADMIN_POLLING = Object.freeze({
    DEPLOY_CHECK_INTERVAL_MS: 2000,  
    DEPLOY_SLOW_INTERVAL_MS: 3000,   
    DEPLOY_MAX_ATTEMPTS: 60,          
    WORKFLOW_TRIGGER_DELAY_MS: 2000   
});

export const IMAGE_PROCESSING = Object.freeze({
    MAX_COVER_DIMENSION: 600  
});
